...
<div class="homework_wrap mb-4">
     <div class="mt-4">
		<div class="sub_tit04 mt-4"><span></span>학생 정보</div>                     
		<div>
		...
		<div class="sub_tit04 mt-4"><span></span>학기 정보</div>                     
		<div>
			<table class="table_style02 table_left table_center hover_none">
				<colgroup>
					<col width="30%">
		...
		<div>
			<table class="table_style02 table_center">
				...
				<c:set var="etrncf" value="${tuitionInfo.tutnEtrncfStr}"/>
				<c:if test="${tuitionInfo.tutnEtrncf == null}">
					<c:set var="etrncf" value="0"/>
				</c:if>
				
				<c:set var="schlship" value="${tuitionInfo.tutnSchlshipStr}"/>
				<c:if test="${tuitionInfo.tutnSchlshipStr == null}">
		...
		<div class="sub_tit04 mt-4"><span></span>납부</div>
		<div>
			<table class="table_style02 table_left table_center hover_none">
				<colgroup>
					<col width="30%">
		...
		<div>
			<table class="table_style02 table_right table_center hover_none">
				...
				<tr><th>납부일</th><td>${tuitionInfo.tutnPayde}</td></tr>		
			</table>
		</div>
	</div>
 </div>