...
<div class="container-fluid">
    <div class="card2">
        ...
        <sec:authentication property="principal" var="principal"/>          
            ...
            <div class="btn_wrap">
                <button type="button" id="deleteCommonNoticeBtn" class="btn btn-danger ft_right" data-bo-no="${board.boNo}" >삭제</button>
             <button data-bo-no="${board.boNo}" id="open_modal" data-toggle="modal" data-target="#modal_open" class="btn btn-danger ft_right" style="margin-right:8px;">
            수정      
            </button>
            </div>
...
<script src="/resources/js/app/ljh/staffCommonNoticeData.js"></script>
<script src="/resources/js/app/ljh/staffCommonNoticeDelete.js"></script>