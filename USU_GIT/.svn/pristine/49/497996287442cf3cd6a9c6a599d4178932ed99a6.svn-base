                   ...
                   <div class="card2">
                       ...
                       <div class="mail_top_wrap">
                       	<ul class="list_stye_round">
								<a class="contentLink" href="/${actorForMail }/mail/mailList"><li>받은쪽지</li></a>
								<a class="contentLink" href="/${actorForMail }/mail/mailSendList"><li class="on">보낸쪽지</li></a>
							</ul>
                       ...
                       <form action="<c:url value='/${actorForMail }/mail/ajax/mailSendList'/>" id="searchForm">
