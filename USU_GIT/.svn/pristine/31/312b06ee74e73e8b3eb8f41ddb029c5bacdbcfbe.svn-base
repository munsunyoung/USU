	    ...
	    <div class="modal-dialog modal-xl" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modalLabel01">교과목 신청</h5>
...
<!-- 반려 사유 입력하는 모달 -->
	<div class="modal fade mt-100" id="courseRefuseModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel01" aria-hidden="true" style="margin-top:90px;">
	    <div class="modal-dialog modal-xs" role="document" id="secondModal">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modalLabel01">교과목 반려</h5>
	              <button id="courseRefuseModalClose" class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
					    <span aria-hidden="true">×</span>
				  </button>
	            </div>
	            <div>
	            	<div class="modal-body">
						...
						<div>
							<form id="refusedCourseRequest" action="/staff/course/updateRefusedCourseRequest" method="post">
								<input type="hidden" id="courseReqstReturn" name="courseReqstReturn">
								<input type="hidden" id="courseReqstNo" name="courseReqstNo">
...
<!-- Begin Page Content -->
               <div class="container-fluid">
                   ...
                   <div class="card2">
                       <div class="sub_tit02">교과목 신청</div>
                           ...
                           <div class="s_option">
                               <div class="select-container">
                                   <select name="searchType" class="custom-select02">
			                            ...
			                            <option value="courseReqstNm" label="교과목명" />
                       ...
                       <form action="<c:url value='/staff/course/ajax/courseRequest'/>" id="searchForm">
...
<script src="/resources/js/app/ljh/staffCourseRequest.js"></script>
