	...
	<div id="modal_cont">
		...
		<div class="modal-body wd85 mt-4">
			...
			<table class="table table_style01 table_center">
				<tr>
					<th>승인구분</th>
					<td><input class="in_txt" type="text" name="" id="" whGubun></td>
					<th>희망상담일</th>
...
<div class="container-fluid">
	...
	<div class="card2" style="min-height:900px;">
		<div class="class_list_wrap">
			<div class="sub_tit02">상담 신청</div>
		...
		<div class="ft_left" style="width: 40%; margin:8px;">
			...
			<div class="select-container ft_left">
				<select name="cnsltSe" id="searchFormCnsltSe" class="custom-select02"
					onchange="whSelChg(this)">
					<option value="all" label="전체" />
					<option value="학사상담" label="학사상담" />
					<option value="취업상담" label="취업상담" />
				</select>
