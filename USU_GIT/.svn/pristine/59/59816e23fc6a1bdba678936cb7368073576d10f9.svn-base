...
<!-- 수정 가능한 입력란  -->
<div id="editFields">
 <form id="noticeUpdateForm" action="/staff/board/staffNoticeUpdateData" method="post"> <!-- Add action and method -->
	<div class="container-fluid">
		<div class="card2">
		 ...
		 <tr>
			<th>공지 구분</th> 
			<td> 
			<select name="bdSe" class="form-style01" >
			...
			<tr>
			<th>제목</th>
			<td> <input type="text" name="boTitle" class="form-style01" value="${board.boTitle}"  required/> </td>
				</tr>
		 </table>
					
			<!-- 내용 -->
			 <table style="width:937px;" class="table table_style01 table_center">
			 <tr>
			<th>내용</th>
...
<script src="/resources/js/app/ljh/staffNoticeUpdateData.js"></script>
