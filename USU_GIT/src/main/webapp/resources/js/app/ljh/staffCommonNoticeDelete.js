...
$("#deleteCommonNoticeBtn").data("boNo", boNo);
	let settings = {
		url : "/board/staffCommonNoticeView",
		method : "GET",
		data : {boNo : boNo},
		dataType : "html"
	};
...
$("#deleteCommonNoticeBtn").on("click", function() {
    ...
    switch (response) {
        case "success":
             Swal.fire({
				...
				setTimeout(function() {
	                location.href = "/staff/staffCommonNoticeListUI";
	            }, 1500);
				break;
        case "fail":
            Swal.fire({
