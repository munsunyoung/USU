...
<div class="container-fluid">
	<div class="card2 ht800">
			...
			<div class="cert_box">
				...
				<div class="blue_box02">
					...
					<label for="agree1" class="radio_box">
						<input type="radio" id="agree1" name="agree" value="재학증명서" checked="checked" />
						<span class="on"></span> 재학증명서
					</label>
					<label for="agree2" class="radio_box">
						<input type="radio"id="agree2" name="agree" value="성적증명서" />
						<span class="on"></span>
							성적증명서
					</label>
					<label for="agree3" class="radio_box">
						<input type="radio"id="agree3" name="agree" value="장학금수혜증명서" />
						<span class="on"></span>
							장학금수혜증명서
					</label>
					<label for="agree4" class="radio_box">
						<input type="radio"id="agree4" name="agree" value="졸업예정증명서" />
						<span class="on"></span>
							졸업예정증명서
					</label>
				</div>
		...
		<div class="Target_article__Xhj_7_paymentMethod">
		 	<div class="cert_tit">결제 수단 </div>
		</div>
					
                     <div class="bankSelect">
                        <div class="payment_radio">                       	
                        	<label for="creditcard"  class="radio_box">
	                        	<input type="radio" id="creditcard" name="payment" value="creditcard" />
	                        	<span class="on"></span> 신용카드	                        	
                        	</label>
                        </div>
                        <div class="payment_radio">
                        	<label id="paymentcheck" for="kakaopay" class="radio_box">
                        	<input type="radio" id="kakaopay" name="payment" value="kakaopay" class="radio_box"/>
                        		<span class="on"></span> 카카오페이
                        	</label>
                        </div>
                        <div class="payment_radio">
                        	<label id="paymentcheck" for="tosspay" class="radio_box">
                        	<input type="radio" id="tosspay" name="payment" value="tosspay" class="radio_box"/>
                        		<span class="on"></span> 토스
							</label>
                        </div>
						<div class="payment_radio">
							<label id="paymentcheck" for="mutongjang" class="radio_box">
							<input type="radio" id="mutongjang" name="payment" value="mutongjang" class="radio_box" />
							<span class="on"></span>무통장 입금
							</label>
						</div>
					</div>     
			...
			<div class="mt-4 btn_wrap"><button id="payment" class="btn btn-primary ft_right mb50"  onclick="requestPay()">결제하기</button></div>
			
			
			<div class="down_box" style="display:none">
				<div>다운받기를 클릭하시면 PDF가 다운로드됩니다.</div>
					<button pdfdown class="btn btn-down"><span class="print_ico"><img src="/resources/img/ico_print.png"></span>PDF 다운받기</button>				
			</div>
			<div class="certificate_wrap" >
				...
				<div>
					...
					<div class="logo_wrap02">
						...
						<div class="logotxt">
							UMSEOK<br> <span>UNIVERSITY</span>
						</div>
					</div>
				</div>
