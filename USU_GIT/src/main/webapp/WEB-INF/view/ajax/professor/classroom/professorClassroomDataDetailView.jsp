...
<div class="homework_wrap mb-4">
     <div>			   
		<div class="sub_tit04"><span></span>자료 정보</div>
			<br/><br/>
			...
			<table class="table_style02 table_center">
				<tr>
					<th>제목</th>
					<td colspan="2">${dataView.crTitle}</td>
				...
				<tr>
					...
					<th>작성일</th>
					<td>${dataView.crDate}</td>
				</tr>
	   		</table>
			<br/><br/>
			<div class="sub_tit04"><span></span>자료 파일</div>
			...
			<tbody>
				<td style="text-align:left; padding-left:10px;">${dataView.crCn}</td>
			</tbody>
	   		</table>
			<br/><br/>
 	</div> 				
