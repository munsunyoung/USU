...
<%@ taglib uri="http://www.springframework.org/security/tags" prefix="security" %><script src='https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js'></script>
				...
				<div class="col-lg-6 mb-4">
					<div class="list_item_wrap">
						...
						<div class="list_item" role="group" aria-label="2 / 4">
							<a href="/professor/mypage/professor/myPageUI">
								<div class="text">
						...
						<div class="list_item bg02 mr-0" role="group" aria-label="2 / 4">
							<a href="${pageContext.request.contextPath}/professor/consultation/professorConsultationRequestListUI" style="color: white;">
								<div class="text">
			...
			<div class="card02 shadow ">
				<div class="class_list_wrap02">
					...
					<div class="tab_contents ht400 scroll_none">
						...
						<a class="ft_right" href="/professor/professorCommonNoticeListUI" style="font-size:30px;">+</a>	
							<div class="mb-4 "> 
						...
						<div id="tab-2" class="tab-content border_none pd-0">
								<div class="mb-4">
									<div gs-id="noticeBoard" class="ht400" style="background-color: white;">
											<a class="ft_right" href="/professor/professorNoticeListUI" style="font-size:30px;">+</a>
										<div  style="padding-top: 10px;">
											<div class="chart-area" style="height: 200px;">
												<table class="table table_style01 table_center" id="dataTable"
													width="100%" cellspacing="0">
...
<script src="${pageContext.request.contextPath }/resources/js/app/msy/professorMainPage.js"></script>
