...
<div class="homework_wrap mb-4">
     <div>
		...
		<div class="sub_tit04 mt-4"><span></span>등록금</div>                     
		<div>
			<table class="table_style02 table_center">
				...
				<fmt:parseNumber value="${tuitionInfo.tutnTutfee}" var="tutfeeNum" />
				...
				<tr>
					<th>수업료</th>
					<td>${tuitionInfo.tutnTutfeeStr} 원</td>
				</tr>	
				<tr>
					<th>장학금</th>
					<td>${schlship} 원</td>
				...
				<tr>
					<th>총 납부액</th>
					<td>${formattedTotalAmt} 원</td>
				</tr>				
			</table>
		</div><br>
		
<!-- 		<div class="sub_tit04"></div> -->
	</div>
 </div>