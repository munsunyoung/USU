...
<script>var sessionRemainTime = '${pageContext.session.maxInactiveInterval }'</script>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- Nav Item - Messages -->
                    <li class="nav-item dropdown no-arrow mx-1"><a class="nav-link dropdown-toggle contentLink" href="/student/mail/mailList"
                    ...
                    <li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
                            ...
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                            	${user.realUser.stdntNm }(${user.realUser.stdntNo })님 안녕하세요
                            </span> <img class="img-profile rounded-circle" src="${pageContext.request.contextPath }/student/profileImage">
                        </a> <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="javascript:;" id="timetableBtn" > <i
                                    class="fas fa-clock fa-sm fa-fw mr-2 text-gray-400"></i> 시간표조회
                            </a>
                            <a class="dropdown-item" href="/student/mypage/student/myPageUI"> <i
