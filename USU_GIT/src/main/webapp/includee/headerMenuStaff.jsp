            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- Nav Item - Messages -->
                        ...
                        <a class="nav-link dropdown-toggle contentLink" href="/staff/mail/mailList" id="mailList" role="button"  aria-haspopup="true"
                    ...
                    <li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
                            ...
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                            	 ${user.realUser.sklstfNm }(${user.realUser.sklstfNo })님 안녕하세요 
                            </span> <img class="img-profile rounded-circle" src="${pageContext.request.contextPath }/staff/profileImage">
                        </a> <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="/staff/mypage/staff/myPageUI"> <i
